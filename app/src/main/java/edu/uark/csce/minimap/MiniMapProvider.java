...
public class MiniMapProvider extends ContentProvider {
    ...
    private static String LOGTAG = "MiniMapProvider:";
    // Database Name for SQLITE DB
    private static final String DBNAME = "MiniMapDB";
    // Authority is the package name
    private static final String AUTHORITY = "edu.uark.csce.minimap.minimapprovider";
    //TABLE_NAME is defined as MiniMap
    private static final String TABLE_NAME = "MiniMap";
    //Create a CONTENT_URI for use by other classes
    public static final Uri CONTENT_URI =
            Uri.parse("content://" + AUTHORITY + "/"+TABLE_NAME);

    //Column names for the MiniMap Table
    public static final String MINIMAP_TABLE_ENTRY_ID = "ID";
    public static final String MINIMAP_TABLE_COL_RED = "RED";
    public static final String MINIMAP_TABLE_COL_GREEN = "GREEN";
    public static final String MINIMAP_TABLE_COL_BLUE = "BLUE";
    public static final String MINIMAP_TABLE_DEVICE_COUNT = "COUNT";
    //Table create string based on column names
    private static final String SQL_CREATE_MAIN = "CREATE TABLE " +
            TABLE_NAME+ " " +                       // Table's name
            "(" +                           // The columns in the table
            MINIMAP_TABLE_ENTRY_ID + " INTEGER PRIMARY KEY, " +
            MINIMAP_TABLE_COL_RED + " INTEGER, " +
            MINIMAP_TABLE_COL_GREEN + " INTEGER," +
            MINIMAP_TABLE_COL_BLUE + " INTEGER," +
            MINIMAP_TABLE_DEVICE_COUNT + " INTEGER)";
    ...
    public int delete(Uri uri, String selection, String[] selectionArgs) {
        switch (sUriMatcher.match(uri)){
            ...
            case 2:
                ...
                selection = MINIMAP_TABLE_ENTRY_ID + "=" + id +
    ...
    protected static final class MainDatabaseHelper extends SQLiteOpenHelper {
        ...
        public void onUpgrade(SQLiteDatabase db, int int1, int int2){
            db.execSQL("DROP TABLE IF EXISTS MiniMap");
            onCreate(db);
